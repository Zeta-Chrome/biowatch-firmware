...
#define UI_UPDATE_CLOCK_NTF BIT(1)
#define UI_ACT_CHANGED_NTF BIT(2)
#define UI_VIT_CHANGED_NTF BIT(3)
#define UI_VIT_ERROR_NTF BIT(4)

#define UI_ENV_CHANGED_NTF BIT(5)
#define UI_BLE_CONNECTED_NTF BIT(6)
#define UI_BLE_ADVERTISING_NTF BIT(7)
#define UI_BLE_DISCONNECTED_NTF BIT(8)

#define UI_SET_CHANGED_NTF BIT(9)
#define UI_DISPLAY_OFF_NTF BIT(10)
#define UI_DISPLAY_ON_NTF BIT(11)
#define UI_SPINNER_UPDATE_NTF BIT(12)
